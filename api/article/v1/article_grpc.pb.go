...
const (
	ArticleService_CreateArticle_FullMethodName  = "/golang_template.article.v1.ArticleService/CreateArticle"
	ArticleService_GetArticleById_FullMethodName = "/golang_template.article.v1.ArticleService/GetArticleById"
)
