...
[![godoc for diki-haryadi/golang-oauth2-server](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/golang-oauth2-server)
...
[![Sourcegraph for diki-haryadi/golang-oauth2-server](https://sourcegraph.com/golang-oauth2-server/-/badge.svg)](https://sourcegraph.com/golang-oauth2-server?badge)
...
This server is easily extended or modified through the use of plugins. Four services, [health](https://golang-oauth2-server/tree/master/health), [oauth](https://golang-oauth2-server/tree/master/oauth), [session](https://golang-oauth2-server/tree/master/session) and [web](https://golang-oauth2-server/tree/master/web) are available for modification.
