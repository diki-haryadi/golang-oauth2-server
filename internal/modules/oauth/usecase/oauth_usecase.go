...
import (
	...
	tokenDto "golang-oauth2-server/internal/modules/oauth/dto"
...
func (uc *useCase) PasswordGrant(ctx context.Context, client *clientDomain.Client) (*tokenDto.AccessTokenResponse, error) {
